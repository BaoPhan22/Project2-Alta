<div class="p-0 left-side-bar col-2 d-flex flex-column flex-shrink-0" id="left-sidebar">
                <div id="main-logo" class="my-4 mx-5 text-center">
                ...
                <div class="w-100 mb-auto">
                    <ul class="nav nav-pills flex-column mb-auto">
                        ...
                        <li>
                            <a href="#" class="nav-link active  link-dark rounded-0 ps-0">
