        ...
        <div class="row">
            <div class="col mt-3 ps-3">
                ...
                <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item fw-bold" aria-current="page"><a href="{{ route('system.role') }}" class="fw-bold text-decoration-none link-dark">Quản lý vai trò</a></li>
                        <li class="breadcrumb-item active-breadcumb fw-bold" aria-current="page"><a href="#" class="fw-bold text-decoration-none active-breadcumb">Thêm vai trò</a></li>
...
<script>document.title='Thêm vai trò'</script>
